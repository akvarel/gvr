...
class ProviderVerificationObservation:
    ...
    def __post_init__(self) -> None:
        ...
        elif self.independence is None:
            object.__setattr__(
                self,
                "independence",
        ...
        elif self.independence.trust_state is IndependenceTrustState.VERIFIED:
            raise ValueError("verified independence requires a sealed origin attestation")
